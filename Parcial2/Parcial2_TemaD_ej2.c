...
EJM1:
Ingrese un char: d
Ingrese un char: Ingrese un char: s
Ingrese un char: Ingrese un char: f
d 
s 
f 
Hay más de dos consonantes

EJM2:
Ingrese un char: a
Ingrese un char: Ingrese un char: a
Ingrese un char: Ingrese un char: a
a 
a 
a 
Hay menos de dos consonantes.
*/